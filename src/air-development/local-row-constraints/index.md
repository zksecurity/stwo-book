...
More specifically, the sorted column will contain in order the values $[0,\text{num\_rows})$, which means that the difference between every current row and the previous row should be $1$.
